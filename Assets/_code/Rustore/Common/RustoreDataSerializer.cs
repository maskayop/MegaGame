...
namespace MegaGame
{
    public static class RustoreDataSerializer
    {
        ...
        static string SerializeToJson(object obj, bool prettyPrint, int indentLevel)
        {
        ...
        static string SerializeDateTime(object obj)
        {
            var dateString = (obj as DateTime?)?.ToString("yyyy-MM-ddTHH:mm:ss.fffZ");
            return $"\"{dateString}\"";
        }

        static string SerializeCollection(ICollection collection, bool prettyPrint, int indentLevel)
        {
        ...
        static string SerializeObject(object obj, bool prettyPrint, int indentLevel)
        {
        ...
        static string SerializeBaseValue(object obj)
        {
            Type type = obj.GetType();
        ...
        static bool IsNumeric(object value) => value is int or long or float or double or decimal;

        static bool IsBaseValue(object obj)
        {
        ...
        static string GetIndent(int level) => new string(' ', level * 4);
    }
}